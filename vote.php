<?php
    ...
    // Temporary green voting pages - on click on this page it turns into normal color for 12h
    // TODO: OnClick Event for each votingpage, seperat counting etc.
    
    $time = time();
    $voted = sql_query("INSERT INTO voting_extern (`user`,`zeit`) VALUES ('$_SESSION[user]', '$time') 
    ON DUPLICATE KEY UPDATE `zeit`='$time';");
